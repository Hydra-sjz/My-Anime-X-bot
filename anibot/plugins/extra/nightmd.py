...
from anibot.utils2.Database.nightdb import nightdb,nightmode_on,nightmode_off,get_nightchats 
...
scheduler.add_job(start_nightmode, trigger="cron", hour=00, minute=20) #hour=23, minute=59
scheduler.start()
